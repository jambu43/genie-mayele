...
export default function ChatInterface() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "2",
      content: "Salut! je suis ton tuteur de langue. Je peux t'aider à apprendre et à patriquer une nouvelle langue, à améliorer tes competences et à maitriser la grammaire. Sur quoi aimerais-tu te concentrer ?",
      sender: "ai",
      timestamp: "10:52"
    }
  ]);
